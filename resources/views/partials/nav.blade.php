        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item {{ (request()->segment(2) == 'trainer_speciality') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('trainer_speciality.index') }}">
                            <i class="align-middle" data-feather="user"></i> <span class="align-middle">Trainer Specialites</span>
                        </a>
                    </li>
